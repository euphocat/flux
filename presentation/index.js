      ...
      <Spectacle theme={theme}>
        <Deck transition={["zoom", "slide"]} transitionDuration={500}>
          ...
          <Slide transition={["zoom"]} bgColor="secondary">
            <Heading size={1} fit caps lineHeight={1}> Flux Architecture </Heading>
            <Heading size={2} bgColor="primary" padding=".1em 0 .2em">(&amp; ReactJS)</Heading>
          </Slide>
          ...
          <Slide>
            <List textColor="tertiary">
              <ListItem><strong>Actions</strong> – Helper methods that facilitate passing data to the
                Dispatcher</ListItem>
              <ListItem><strong>Dispatcher</strong> – Receives actions and broadcasts payloads to registered
                callbacks</ListItem>
              <ListItem><strong>Stores</strong> – Containers for application state & logic that have callbacks
                registered to the dispatcher</ListItem>
              <ListItem><strong>Controller Views</strong> – React Components that grab the state from Stores and pass it
                down via props to child components.</ListItem>
            </List>
          </Slide>
          ...
          <Slide>
            <Heading size={2} caps textColor="tertiary"> The good parts </Heading>
            <List textColor="tertiary">
              <ListItem textColor="secondary">Very stricts rules enforced by the Dispatcher</ListItem>
              <ListItem>Dispatcher = real controller, all states changes go through them</ListItem>
              <ListItem textColor="secondary">Stores = Model, not db wrappers but just plain state</ListItem>
              <ListItem>Unidirectional dataflow</ListItem>
              <ListItem textColor="secondary">Easier for unit testing</ListItem>
              <ListItem>Great for scaling</ListItem>
            </List>
          </Slide>

          <Slide bgColor="secondary">
            <Heading size={2} caps textColor="tertiary"> The bad parts </Heading>
            <List textColor="tertiary">
              <ListItem textColor="primary">Lot of implemenations</ListItem>
              <ListItem>No middleware for actions (need for extra Actions Creator)</ListItem>
              <ListItem textColor="primary">View dependency to the store</ListItem>
          ...
          <Slide>
            ...
            <List textColor="tertiary">
              ...
              <ListItem><strong>State is read-only:</strong> the only way to mutate the state is to emit an
                action</ListItem>
              <ListItem><strong>Changes</strong> are made with <strong>pure functions</strong></ListItem>
              <ListItem><strong>Redux does not have the concept of a Dispatcher</strong> pure functions instead of event
                emitters</ListItem>
          ...
          <Slide bgColor="secondary">
            ...
            <Appear><Image src={images.fountain.replace("/", "")}  width="100%"/></Appear>
          </Slide>
